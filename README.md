...
My work is about understanding how learning works, in biological brains and in artificial systems, and applying that to solve real-world problems with data.
...
## Applied ML & technical projects

Take a look at some of the AI-for-good and data-for-good projects I've been involved in.

* **Early intervention in sustainability intelligence**: a company launches a campaign to monitor the sustainability of its supply chain, inviting suppliers to get assessed by EcoVadis. EcoVadis proactively predicts how likely each supplier is to complete their assessment, targeting extra resources at those that need extra convincing. Partway through the campaign, there are signs that something is not right: the predictions indicate under-performance, threatening the client company's sustainability programme. I revamped the binary classifier that makes these predictions, incorporating real-time signals to make the model more responsive, and used SHAP to help teams understand why campaigns were under-performing and what they could do about it - before the campaign had completed. This supported EcoVadis frontline teams and clients' procurement teams to meet their supply chain sustainability targets.

* **Classifying risk construction elements**: could you tell if a wall was built 5cm off from where it should be? At Naska.AI, I developed techniques to classify LIDAR point-cloud representations of architectural elements such as walls as being correctly positioned or not. I used classification filtering, hierarchical clustering based on learned representations, and vision-language foundation models to continuously improve on our core classification model. The result enabled clients to identify risk in their construction projects early, and reduce waste in one of the most polluting (but necessary!) industries.  
  📎 [YouTube video about our software](https://youtu.be/2yqSL-wUgOs)
